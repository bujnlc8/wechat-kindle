...
<div width="100%">
<?php
$sql = "select bi.book_id,bi.book_name,bi.book_writer,bi.book_url from bookinfo bi  where book_class='1' ";
$sqlCount ="select count(*) from  bookinfo bi  where book_class='1' ";
$con = getMysqlCon();
