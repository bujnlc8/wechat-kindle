...
<div class="weui_cells">
    <div class="weui_cell">
        <div class="weui_cell_ft">
            <p align="left">  <?php echo $fileName;?></p>
        </div>
    </div>
    <div class="weui_cell">
        <div class="weui_cell_ft">
...
if($fileType=='mobi' ||$fileType=='azw'){
        echo "<div class=\"button_sp_area\"><a onclick=send2Kindle('$url','$bookName') class=\"weui_btn weui_btn_plain_primary\">推送至kindle</a></div>";
        echo "<div class=\"button_sp_area\"><a onclick=send2MailUrl('$url','$bookName') class=\"weui_btn weui_btn_plain_primary\">发送至邮箱</a></div>";
}else{
     echo "<div class=\"button_sp_area\"><a onclick=send2MailUrl('$url','$bookName') class=\"weui_btn weui_btn_plain_primary\">发送至邮箱</a></div>";
}
}
	...
	<div class="weui_dialog_alert" id="dialog6" style="display: none;">
     ...
     <div class="weui_dialog_alert" id="dialog3" style="display: none;">
        ...
        <div class="weui_dialog">
            ...
            <div class="weui_dialog_bd">发送成功,稍后将书籍发送至您的邮箱！</div>
            <div class="weui_dialog_ft">
 ...
 <script>
    function send2Kindle(url,bookName){
        $.ajax({
     ...
     function send2MailUrl(url,bookName){
        $.ajax({
