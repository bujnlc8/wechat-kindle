...
<meta name="viewport" content="width=device-width, initial-scale=1" />  
    <style type="text/css">
        ...
        .row a{
           width:15%;font-size:0.7em;text-decoration:none;padding:2px; text-align:center;
        }
    </style>
...
//$arrSize = count($arr);
if($num>0){
    echo "<div class='table-responsive'><table class='bordered highlight' style='width:100%;'><tr><th style='width:8%'>序号</th><th style='width:16%'>userName</th><th style='width:15%'>reqWord</th>";
    if(!is_mobile()){
        echo "<th style='width:15%'>reqTime</th><th>回复</th><th>操作</th></tr>";  
    }else{
...
while($log = mysqli_fetch_row($result)) {
    ...
    if(!is_mobile()){
        echo " <td title='$log[5]'>$log[5]</td><td><a onclick=deleteLog('$log[0]')>删除</a></td></tr>";
    }else{
        echo "</tr>"; 
    }
