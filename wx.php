        ...
        switch ($object->Event) {
            ...
            case "CLICK":
                ...
                if($content=='haihuilingWeixinBook'){
                    ...
                    $content = "这是一个个人电子书分享的公众号，里面包含了我这几年收集的所有电子书，大部分为原版,大家可以根据自己的需要免费获取。由于考虑到流量费用问题，当前每位用户每天只能推送20次。另外,下载的书籍严禁商用，如果有任何疑问，请联系微信 haihuilinghuster ,谢谢大家的支持！最后祝大家阅读愉快！";
